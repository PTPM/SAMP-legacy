new mode_name[] = "Protect the PM 2 v1.2";
...
Motd(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(Several bug fixes and tweaks)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(More 0.2 features coming soon)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(Please report any bugs to the forum)");
