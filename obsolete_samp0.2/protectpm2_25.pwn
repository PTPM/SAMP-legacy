new mode_name[] = "Protect the PM 2 v2.5";
...
public PlayerMapVote(playerid, map[])
{
	...
	if (streq(map,"ls_hydra") || streq(map,"ls_h")) {
		player_map[playerid] = 0;
		player_vote_status = "Vote for \"Los Santos Hydra\" added.";
	} else if (streq(map,"sf") || streq(map,"san_fierro") || streq(map,"san_fiero")) {
		player_map[playerid] = 1;
		player_vote_status = "Vote for \"San Fierro\" added.";
	} else if (streq(map,"desert") || streq(map,"d") || streq(map,"des")) {
	...
	} else if (streq(map,"lv_obj") || streq(map,"lv_objective") || streq(map,"lv_ob")) {
	...
	} else if (streq(map,"ls") || streq(map,"los_santos")) {
		player_map[playerid] = 8;
		player_vote_status = "Vote for \"Los Santos\" added.";
	} else if (streq(map,"lv") || streq(map,"las_venturas")) {
