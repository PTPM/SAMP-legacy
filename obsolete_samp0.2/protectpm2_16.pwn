new mode_name[] = "Protect the PM 2 v1.6";
...
#define SPAM_LIMIT 6 // players are allowed this many repeats before they are punished
new player_repeat[MAX_PLAYERS];
new player_repeat_count[MAX_PLAYERS];
new previous_text[MAX_PLAYERS][256];
...
public OnGameModeInit()
{
	...
	new desert_weather_start = random(NUM_DESERT_WEATHER);
	new country_weather_start = random(NUM_COUNTRY_WEATHER);
	new city_weather_start = random(NUM_CITY_WEATHER);
	...
	if (map==0) {
		...
		CreateObject(8613,977.86,-1016.01,45.99,0.00,0.00,-0.04); // stairs
		CreateObject(984,1075.63,-979.33,52.97,180.00,0.00,174.86); // backfence
		CreateObject(984,1061.32,-980.19,52.87,180.00,0.00,180.07); // frontfence
		CreateObject(1687,1065.96,-977.54,53.07,0.00,0.00,0.22); // power1
		CreateObject(1688,1066.02,-983.27,53.27,0.00,0.00,90.73); // power2
		CreateObject(1689,1072.08,-980.62,53.17,0.00,0.00,630.25); // vents
		CreateObject(983,1074.75,-988.90,52.92,180.00,0.00,354.58); // smallfence
		
		CreateObject(3796,428.13,-1641.37,46.84,0.00,92.00,669.49); // boxblock
		CreateObject(983,389.22,-1636.40,41.50,0.00,90.00,459.92); // fence1
		CreateObject(983,389.01,-1635.20,41.50,0.00,90.00,460.14); // fence2
...
//		AddStaticPickup(PICKUP_PARACHUTE,2,1529.0437,-1364.1820,327.8988); // parachute
		...
		class_terrorist1 = AddPlayerClass2(181, WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_M4,300);
		class_terrorist2 = AddPlayerClass2(183, WEAPON_SAWEDOFF,300, WEAPON_M4,400, WEAPON_FLAMETHROWER,300);
		class_terrorist3 = AddPlayerClass2(179, WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_FLAMETHROWER,300);
		class_terrorist4 = AddPlayerClass2(191, WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_M4,300);
		class_terrorist5 = AddPlayerClass2(111, WEAPON_SAWEDOFF,300, WEAPON_M4,400, WEAPON_SILENCED,300);
		...
		EnableTirePopping(1);
		SetWeather2(0,city_weather_start);
		...
		AddWeaponPickup(PICKUP_SNIPER,WEAPON_SNIPER,25,-1825.8746,1026.8816,45.2326,30,WP_SYNCED);
		AddWeaponPickup(PICKUP_SNIPER,WEAPON_SNIPER,25,-1727.9237,182.3361,3.5547,30,WP_SYNCED);
		...
		CreateObject(3804,-2741.20,630.17,29.76,0.00,0.00,540.01); // 1fan
		CreateObject(3804,-2741.20,626.17,29.76,0.00,0.00,540.01); // 2fan
		CreateObject(3804,-2741.20,622.17,29.76,0.00,0.00,540.01); // 3fan
		CreateObject(6976,-2721.33,629.41,36.09,0.00,0.00,540.72); // stairs

		CreateObject(3805,-1950.65,971.21,55.73,90.00,0.00,360.87); // fan1
		CreateObject(3805,-1950.65,975.21,55.73,90.00,0.00,360.87); // fan2
		CreateObject(3805,-1950.65,979.21,55.73,90.00,0.00,360.87); // fan3
		CreateObject(3805,-1950.65,983.21,55.73,90.00,0.00,360.87); // fan4
		CreateObject(3805,-1950.65,987.21,55.73,90.00,0.00,360.87); // fan5
		CreateObject(3805,-1950.65,991.21,55.73,90.00,0.00,360.87); // fan6
		CreateObject(3805,-1950.65,995.21,55.73,90.00,0.00,360.87); // fan7
		CreateObject(3805,-1950.65,999.21,55.73,90.00,0.00,360.87); // fan8
		CreateObject(6976,-1973.37,985.35,57.81,0.00,0.00,180.17); // stairsback
		CreateObject(8613,-1981.28,953.31,46.54,0.00,0.00,270.24); // stairsfront
		CreateObject(1697,-1958.22,1019.50,68.20,0.00,0.00,360.99); // solar1
		CreateObject(1697,-1949.22,1019.50,68.20,0.00,0.00,360.99); // solar2

		CreateObject(3796,-1377.35,492.40,7.34,90.00,0.00,450.04); // boxblock armyship
...
*/
		...
		class_terrorist1 = AddPlayerClass2(181, WEAPON_SAWEDOFF,300, WEAPON_M4,400, WEAPON_FLAMETHROWER,300);
		class_terrorist2 = AddPlayerClass2(183, WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_M4,300);
		class_terrorist3 = AddPlayerClass2(179, WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_FLAMETHROWER,300);
		class_terrorist4 = AddPlayerClass2(191, WEAPON_SAWEDOFF,300, WEAPON_M4,400, WEAPON_SILENCED,300);
		class_terrorist5 = AddPlayerClass2(111, WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_MOLTOV,15);
        ...
        AllowInteriorWeapons(1);
		EnableTirePopping(1);
		SetWeather2(2,desert_weather_start);
...
//		AddBannedCuboid(230,225,1874,1869,14,0,"",248.8800,1849.9883,8.7734,0);
		...
		CreateObject(969,265.51,1820.82,9.63,90.00,0.00,180.30); // fence2
		CreateObject(969,257.04,1827.36,9.58,90.00,0.00,1.04); // fence1
		...
		CreateObject(987,2132.19,1621.70,999.81,0.00,0.00,357.76); // fenceblock
		...
		class_terrorist1 = AddPlayerClass2(181, WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_MOLTOV,10);
		class_terrorist2 = AddPlayerClass2(183, WEAPON_SAWEDOFF,300, WEAPON_M4,400, WEAPON_FLAMETHROWER,300);
		class_terrorist3 = AddPlayerClass2(179, WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_FLAMETHROWER,300);
		class_terrorist4 = AddPlayerClass2(191, WEAPON_SAWEDOFF,300, WEAPON_M4,400, WEAPON_SILENCED,300);
		class_terrorist5 = AddPlayerClass2(111, WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_MOLTOV,10);
		class_terrorist6 = AddPlayerClass2(73,  WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_SILENCED,300);
		class_terrorist7 = AddPlayerClass2(100, WEAPON_SILENCED,300, WEAPON_M4,400, WEAPON_FLAMETHROWER,300);
		class_terrorist_medic = AddPlayerClass2(274, WEAPON_PARACHUTE,-1,WEAPON_SILENCED,100,WEAPON_SPRAYCAN,300);
...
*/
		...
		CreateObject(5986,-1394.700073,-2737.722656,94.454933,0,0,270);
		CreateObject(2929,-1391.538696,-2729.938232,89.740944,0,0,90.2409);
		CreateObject(5822,-1395.752930,-2736.695313,86.633812,0,0,276.0934);
		CreateObject(2929,-1391.557129,-2727.572998,89.745232,0,0,90.2409);
		CreateObject(5822,-1377.727051,-2716.296875,100.408150,0,0,276.0934);
		CreateObject(6102,-1231.572021,-1924.278564,7.584078,0,0,303.75);
		CreateObject(5822,-1243.021240,-1926.279541,3.904521,0,0,128.1246);
		CreateObject(3361,-1185.534180,-1963.030884,14.909491,0,0,33.75);
		CreateObject(3361,-1180.844116,-1959.888794,11.159510,0,0,33.75);
		CreateObject(3776,-1345.151367,-1510.978271,30.946987,0,0,0);
		CreateObject(3776,-919.398193,-1088.529541,105.813828,0,0,326.25);
		CreateObject(5130,-2022.970215,-1082.461914,49.338943,0,0,224.9228);
		CreateObject(5822,-2044.633667,-1081.143799,39.786896,0,0,6.9528);
		CreateObject(18368,-1986.675171,-1027.376465,52.756893,0,0,263.0472);
		CreateObject(18259,-1961.971191,-1060.714966,54.698631,0,0,180);
		CreateObject(18259,-1268.360107,-2045.176880,21.754488,0,0,63.9076);
		CreateObject(3092,-2409.773193,-2183.314941,34.226871,0,0,270);
		CreateObject(2909,-1198.160889,-1973.060181,1.308082,0,0,303.75);
		CreateObject(3030,-1236.063721,-1991.852783,21.247726,0,0,0);
		CreateObject(2909,-1192.803345,-1969.477539,1.327233,0,0,303.75);
		CreateObject(6973,-1233.19,-1967.91,24.61,0.00,0.00,214.02); // helipad
		CreateObject(3997,-1226.334473,-1899.111084,-4.665723,0,0,303.75);
		CreateObject(3865,-1217.70,-1982.42,22.71,270.00,0.00,247.32); // pipe1
		CreateObject(3865,-1217.69,-1982.42,20.70,90.00,0.00,270.88); // pipe2
		CreateObject(3865,-1224.97,-1972.34,22.71,270.00,0.00,9.80); // pipe3
		CreateObject(3865,-1224.97,-1972.34,20.70,90.00,0.00,9.80); // pipe4
		CreateObject(8661,-1219.22,-1989.07,-14.50,90.00,0.00,33.24); // underblock1
		CreateObject(8661,-1186.51,-1967.45,-14.50,90.00,0.00,394.40); // underblock2
		CreateObject(8661,-1163.62,-1951.94,-14.56,90.00,0.00,33.46); // underblock3
		CreateObject(8661,-1274.53,-1835.68,-14.56,-270.00,0.00,213.88); // underblock4
		CreateObject(8661,-1304.02,-1854.80,-14.66,90.00,0.00,213.43); // underblock5
		CreateObject(8661,-1309.31,-1882.16,-14.64,90.00,0.00,304.11); // underblock6
		CreateObject(8661,-1287.13,-1915.31,-14.63,90.00,0.00,303.34); // underblock7
		CreateObject(8661,-1246.90,-1983.34,-14.69,90.00,0.00,303.18); // underblock8
		CreateObject(8661,-1269.29,-1950.22,-14.68,90.00,0.00,304.46); // underblock9
		CreateObject(969,-1277.28,-1932.91,-4.86,0.00,90.00,211.64); // underblock10
		CreateObject(969,-1274.97,-1931.27,-4.78,0.00,90.00,214.90); // underblock11
		CreateObject(8661,-1231.73,-1962.64,0.46,360.00,0.00,123.06); // platform
		CreateObject(8661,-1223.43,-1957.17,-9.51,90.00,0.00,122.88); // platformblock1
		CreateObject(8661,-1242.63,-1945.99,-19.53,0.00,-90.00,303.64); // platformblock2
...
//  		AddGameBoundaryCorner(-959,-3000);
		...
		class_terrorist1 = AddPlayerClass2(181, WEAPON_SAWEDOFF,300, WEAPON_M4,400, WEAPON_FLAMETHROWER,300);
		class_terrorist2 = AddPlayerClass2(183, WEAPON_SAWEDOFF,300, WEAPON_M4,400, WEAPON_MOLTOV,10);
		class_terrorist3 = AddPlayerClass2(179, WEAPON_SAWEDOFF,300, WEAPON_RIFLE,30, WEAPON_FLAMETHROWER,300);
		class_terrorist4 = AddPlayerClass2(191, WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_SILENCED,300);
		class_terrorist5 = AddPlayerClass2(111, WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_MOLTOV,10);
		class_terrorist6 = AddPlayerClass2(73,  WEAPON_SAWEDOFF,300, WEAPON_RIFLE,30, WEAPON_SILENCED,300);
		class_terrorist7 = AddPlayerClass2(100, WEAPON_SILENCED,300, WEAPON_M4,400, WEAPON_FLAMETHROWER,300);
		class_terrorist_medic = AddPlayerClass2(274, WEAPON_PARACHUTE,-1,WEAPON_SILENCED,100,WEAPON_SPRAYCAN,300);
		...
		AllowInteriorWeapons(1);
		EnableTirePopping(1);
		SetWeather2(1,country_weather_start);
 ...
 */
		...
		class_terrorist2 = AddPlayerClass2(183, WEAPON_RIFLE,30, WEAPON_MP5,400, WEAPON_MOLTOV,10);
		class_terrorist3 = AddPlayerClass2(179, WEAPON_SAWEDOFF,100, WEAPON_MP5,400, WEAPON_FLAMETHROWER,100);
		class_terrorist4 = AddPlayerClass2(191, WEAPON_RIFLE,30, WEAPON_MP5,400, WEAPON_SHOTGUN,100);
		class_terrorist5 = AddPlayerClass2(111, WEAPON_SAWEDOFF,100, WEAPON_M4,400, WEAPON_SILENCED,300);
		class_terrorist6 = AddPlayerClass2(73,  WEAPON_SAWEDOFF,100, WEAPON_MP5,400, WEAPON_MOLTOV,10);
...
//		AddStaticPickup(PICKUP_PARACHUTE,2,1529.0437,-1364.1820,327.8988); // parachute
		...
		class_terrorist3 = AddPlayerClass2(179, WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_FLAMETHROWER,300);
		class_terrorist4 = AddPlayerClass2(191, WEAPON_SAWEDOFF,300, WEAPON_M4,400, WEAPON_MOLTOV,10);
		...
		class_terrorist4 = AddPlayerClass2(191, WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_SILENCED,300);
		class_terrorist5 = AddPlayerClass2(111, WEAPON_SAWEDOFF,300, WEAPON_M4,400, WEAPON_SILENCED,300);
		class_terrorist6 = AddPlayerClass2(73,  WEAPON_SAWEDOFF,300, WEAPON_MP5,400, WEAPON_MOLTOV,10);
		class_terrorist7 = AddPlayerClass2(100, WEAPON_SILENCED,300, WEAPON_M4,400, WEAPON_MOLTOV,10);
		class_terrorist_medic = AddPlayerClass2(274, WEAPON_PARACHUTE,-1,WEAPON_SILENCED,100,WEAPON_SPRAYCAN,300);
...
//		AddStaticPickup(PICKUP_PARACHUTE,2,2592.9968,2635.4167,109.1719);
		...
		CreateObject(1635,2607.10,2802.67,23.92,0.00,0.00,449.39); // bluewalkwayfandouble
		CreateObject(3399,2688.31,2676.71,18.22,0.00,0.00,539.69); // doublestairpart2
		CreateObject(3399,2696.77,2676.70,14.22,0.00,0.00,180.33); // doublestairpart1
		CreateObject(1617,2681.29,2708.08,20.44,0.00,0.00,359.55); // singlefanladderpart2
		CreateObject(1617,2681.29,2712.07,17.95,0.00,0.00,360.12); // singlefanladderpart1
		CreateObject(8572,2690.36,2712.89,24.34,0.00,0.00,179.36); // bluething1stairs
		CreateObject(1635,2584.97,2687.13,18.82,0.00,0.00,179.74); // fencedoublefanclimb
...
//		AddBannedCuboid(2703,2701,2678,2676,25,23,"",2703.1213,2674.4536,10.8203,177,false,0); // lump down
		AddBannedCuboid(2588,2587,2639,2638,11,10,"",2589.4565,2638.3140,109.1749,267,false,0); //tower 1 up
		AddBannedCuboid(2597,2596,2639,2638,110,109,"",2585.5278,2638.7070,10.8203,86,false,0); // tower 1 down
		AddBannedCuboid(2501,2500,2691,2690,11,10,"",2503.0115,2690.4963,74.8281,267,false,0); // tower 2 up
		AddBannedCuboid(2502,2501,2691,2690,77,76,"",2503.3506,2690.4451,10.8130,183,false,0); // tower 2 down
		AddBannedCuboid(2713,2712,2774,2773,11,10,"",2715.1074,2773.7234,74.8281,266,false,0); // tower 3 up
		AddBannedCuboid(2714,2713,2774,2773,77,76,"",2715.3704,2773.9868,10.8203,183,false,0); // tower 3 down
		AddBannedCuboid(2633,2632,2836,2835,25,24,"",2632.4780,2835.6714,122.9219,185,false,0); // tower 4 up
		AddBannedCuboid(2633,2632,2830,2829,123,122,"",2632.7471,2837.5491,21.3222,359,false,0); // tower 4 down
//		AddBannedCuboid(2563,2562,2725,2724,13,12,"",2562.4490,2721.8955,22.9507,180); // jump up
		AddBannedCuboid(2563,2562,2724,2723,25,24,"",2562.5586,2726.2371,10.9844,357,false,0); // jump down
		AddBannedCuboid(2658,2657,2644,2643,37,36,"",2657.2871,2640.6255,10.8203,182,false,0); // vat 1 down
		AddBannedCuboid(2658,2657,2644,2643,11,10,"",2657.7510,2646.1182,35.2998,358,false,0); // vat 1 up
		AddBannedCuboid(2572,2571,2644,2643,11,10,"",2571.1497,2646.0725,35.2054,354,false,0); // vat 2 up
		AddBannedCuboid(2572,2571,2644,2643,37,36,"",2571.2136,2639.6768,10.8203,182,false,0); // vat 2 down
		AddBannedCuboid(2636,2635,2833,2832,25,24,"",2635.3770,2832.2854,40.3281,87,false,0); // build up
//		AddBannedCuboid(2608,2607,2803,2802,24,23,"",2607.3660,2803.6421,27.8203,0,false,0); // quad up
		AddBannedCuboid(2595,2594,2705,2704,26,25,"",2582.8018,2703.7966,22.9507,89,false,0); // jump
		AddBannedCuboid(2570,2498,2617,2605,50,0,"~w~Not allowed there.",2534.9709,2654.6030,10.8203,310,true,0);
		AddBannedCuboid(2498,2487,2690,2617,50,0,"~w~Not allowed there.",2534.9709,2654.6030,10.8203,310,true,0);
		AddBannedCuboid(2751,2702,2665,2617,50,0,"~w~Not allowed there.",2700.0085,2667.0061,10.8203,40,true,0);
...
// AddSecurityCamera();
	...
	if (map == 0 || map == 1 || map == 4 || map == 8 || map == 9 || map == 10 || map == 5) {
	    printf("Weather: %d\n",city_weather[city_weather_start]);
	} else if (map == 6 || map == 7 || map == 11) {
		printf("Weather: %d\n",city_weather[country_weather_start]);
	} else if (map == 2 || map == 3) {
		printf("Weather: %d\n",city_weather[desert_weather_start]);
	}
...
AntiSpam(playerid, text[])
{
	...
	if (text[0] == '/') {
	    ...
	    if (!streq(command,"/me")) return;
	}
	
	if (streq(previous_text[playerid],text)) {
	    player_repeat[playerid]++;
	    if (player_repeat[playerid] == SPAM_LIMIT+1) {
	        player_repeat_count[playerid]++;
        	new message[256];
	        if (player_repeat_count[playerid] == 1) {
	    		player_mute_time[playerid] = 30;
	    		player_muted[playerid] = 1;
				format (message,sizeof message,"~g~You have been muted for 30 seconds for repeating.");
	    		...
	    		player_muted[playerid] = 1;
				format (message,sizeof message,"~g~You have been muted for 60 seconds for repeating. ~n~~r~FINAL WARNING");
				GameTextForPlayer(playerid,message,6000,GAME_TEXT_STYLE_SMALL);
			} else if (player_repeat_count[playerid] == 3) {
			    GetPlayerName(playerid, message, sizeof message);
				format(message, sizeof message, "%s was kicked from the server for repeated spamming.",message);
	...
	format(previous_text[playerid],256,"%s",text);
}
