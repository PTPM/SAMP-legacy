new mode_name[] = "Protect the PM 2 v1.4";
...
*/
		...
		AddWeaponPickup(PICKUP_SNIPER,WEAPON_SNIPER,30,-2341.80,-1985.90,327.28,30,WP_SYNCED);
...
Motd(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: Weather system added)");
