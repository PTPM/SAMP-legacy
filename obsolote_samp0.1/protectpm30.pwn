new mode_name[] = "Protect the Prime Minister 3.0";
...
#define PICKUP_BASEBALLBAT 336
#define PICKUP_SHOVEL 337
#define PICKUP_POOLCUE 338
#define PICKUP_KATANA 338
#define PICKUP_CHAINSAW 341
#define PICKUP_PURPLEDILDO 321
#define PICKUP_WHITEDILDO 322
#define PICKUP_LONGWHITEDILDO 323
#define PICKUP_WHITEDILDO2 324
#define PICKUP_FLOWERS 325
#define PICKUP_CANE 326
//#define PICKUP_GRENADES 342
//#define PICKUP_TEAR_GAS 343
//#define PICKUP_MOLOTOVS 344
...
//#define PICKUP_SNIPER_RIFLE 358
//#define PICKUP_RPG 359
//#define PICKUP_MISSILE_LAUNCHER 360
#define PICKUP_FLAMETHROWER 361
#define PICKUP_MINIGUN 362
//#define PICKUP_SACHET_CHARGES 363
//#define PICKUP_DETONATOR 364
#define PICKUP_SPRAYPAINT 365
...
#define POSH3 541  //bullet
#define POSH4 506  //supergt
...
public OnGameModeInit()
{
	...
	if (map==0) {
        ...
        AddStaticVehicle2(POSH4,-2168.5137,1251.3845,27.4573,358.0133,-1,-1);
		...
		AddStaticVehicle2(CONV1,-2391.2390,1125.9204,55.8569,339.7648,-1,-1); // conv
		AddStaticVehicle2(SUV3,-2421.8684,1133.9849,55.8559,345.8843,-1,-1); // suv
		AddStaticVehicle2(CONV2,-2485.5100,1137.4042,55.8537,359.9205,-1,-1); // conv
		...
		AddStaticVehicle2(RUSTLER,353.9327,2534.6245,17.4273,167.3655,-1,-1); // Muscle
		...
		AddStaticPickup(PICKUP_UZI,2,102.0130,1900.9927,33.8984); // Uzis
		AddStaticPickup(PICKUP_UZI,2,102.0130,1900.9927,33.8984); // Uzis
		AddStaticPickup(PICKUP_MINIGUN,2,-185.0072,1886.8285,115.7031); // Minigun
		AddStaticPickup(PICKUP_MP5,2,-329.5251,1860.5280,44.5668); // MP5
		AddStaticPickup(PICKUP_TEC9,2,-220.5080,1801.8065,103.7095); // SMG
		AddStaticPickup(PICKUP_FLAMETHROWER,2,-98.1209,2270.3389,122.4016); // Flamethrower
		...
		AddStaticPickup(PICKUP_DEAGLE,2,-83.6319,1525.7402,17.2205); // Dessert Eagle
		AddStaticPickup(PICKUP_MP5,2,-127.1452,2258.0967,28.3973); // MP5
		AddStaticPickup(PICKUP_NITESTICK,2,-377.7772,2243.2141,42.6185); // Nightstick (cop weapon)
		AddStaticPickup(PICKUP_ARMOR,2,-504.9502,2027.8844,43.7017); // Armour
		AddStaticPickup(PICKUP_TEC9,2,278.0169,2023.8375,17.6406); // SMG
		AddStaticPickup(PICKUP_FLAMETHROWER,2,246.4423,1411.0696,23.3703); // Flamethrower
		AddStaticPickup(PICKUP_FLAMETHROWER,2,246.7062,1385.9924,23.3750); // Flamethrower
		AddStaticPickup(PICKUP_FLAMETHROWER,2,215.0238,1468.0563,23.7344); // Flamethrower
		AddStaticPickup(PICKUP_DEAGLE,2,487.3661,1535.1282,1.0032); // DesertEagle
		AddStaticPickup(PICKUP_FIREEXTINGUISHER,2,431.8049,2537.3123,16.2685); // Fire Extinguisher

		AddStaticPickup(PICKUP_DEAGLE,2,-480.4825,2180.6299,41.8672);


		AddStaticPickup(PICKUP_SHOVEL,2,-140.2877,1496.0981,21.3760);
		AddStaticPickup(PICKUP_SHOVEL,2,-137.3183,1500.3707,20.3800);
		AddStaticPickup(PICKUP_CHAINSAW,2,-102.5674,1368.8951,10.2734);


		AddStaticPickup(PICKUP_SHOVEL,2,304.1429,2228.8489,34.7733);
		AddStaticPickup(PICKUP_SPRAYPAINT,2,314.1726,2222.2141,35.7107);
		AddStaticPickup(PICKUP_SHOTGSPA,2,136.8696,1875.2312,22.4375);
		AddStaticPickup(PICKUP_SHOTGSPA,2,136.8696,1875.2312,22.4375);
		AddStaticPickup(PICKUP_SHOTGSPA,2,136.8696,1875.2312,22.4375);
		AddStaticPickup(PICKUP_SHOTGSPA,2,136.8696,1875.2312,22.4375);
		AddStaticPickup(PICKUP_SHOTGSPA,2,136.8696,1875.2312,22.4375);
		AddStaticPickup(PICKUP_LONGWHITEDILDO,2,540.9449,2358.8433,30.9870);
		AddStaticPickup(PICKUP_FLOWERS,2,553.3507,2274.7832,34.4340);
		AddStaticPickup(PICKUP_POOLCUE,2,23.6597,1363.0038,9.1719);
		AddStaticPickup(PICKUP_BASEBALLBAT,2,6.1200,1382.3802,9.1781);
		AddStaticPickup(PICKUP_PURPLEDILDO,2,-21.2242,1390.1115,9.1719);
		AddStaticPickup(PICKUP_AK47,2,-336.0703,1293.3424,53.6643);
		AddStaticPickup(PICKUP_BASEBALLBAT,2,-590.3543,2018.4451,60.3828);
		AddStaticPickup(PICKUP_KATANA,2,-597.6247,2022.2175,60.3818);
		AddStaticPickup(PICKUP_AK47,2,-653.5152,2040.8524,60.3906);
		AddStaticPickup(PICKUP_SILENCED,2,-127.5074,1926.5990,15.3981);
		...
		AddStaticPickup(PICKUP_CHAINSAW,2,-171.3368,2526.1011,26.2891); // Chainsaw
		AddStaticPickup(PICKUP_SHOVEL,2,-168.2105,2521.9858,25.3978); // Shovel
		AddStaticPickup(PICKUP_TEC9,2,-35.9747,2349.6221,24.3026); // Tec-9 (new)
		AddStaticPickup(PICKUP_UZI,2,-149.8675,1596.4629,17.4454); // Micro Uzi
		AddStaticPickup(PICKUP_CHAINSAW,2,-88.1425,1579.7565,19.9543); // Chainsaw
		AddStaticPickup(PICKUP_SHOVEL,2,-93.6178,1586.4666,19.5323); // Shovel
		AddStaticPickup(PICKUP_DEAGLE,2,-152.0274,1320.9338,13.8111); // Desert Eagle
		AddStaticPickup(PICKUP_UZI,2,-249.2702,1314.6149,36.9502); // Micro Uzi
		AddStaticPickup(PICKUP_SILENCED,2,1.5069,1517.4351,12.7500); // Silenced Pistol
		AddStaticPickup(PICKUP_DEAGLE,2,161.8201,1504.1044,10.5859); // Desert Eagle
		AddStaticPickup(PICKUP_TEC9,2,392.8684,1430.7505,7.7917); // Tec 9
		AddStaticPickup(PICKUP_DEAGLE,2,548.5426,2273.8989,34.7579); // Desert Eagle
		AddStaticPickup(PICKUP_SHOTGUN,2,399.8705,2429.5833,16.4885); // Shotgun (regular)
		AddStaticPickup(PICKUP_AK47,2,113.2080,2406.0139,17.3938); // AK 47
		AddStaticPickup(PICKUP_SHOTGSPA,2,414.3580,2533.0876,23.3131); // Combat Shotgun
		AddStaticPickup(PICKUP_FLAMETHROWER,2,-338.3566,1985.2874,131.4921); // Flamethrower (lots of ammo)
		AddStaticPickup(PICKUP_FLAMETHROWER,2,-338.3566,1985.2874,131.4921); // Flamethrower (lots of ammo)
		AddStaticPickup(PICKUP_FLAMETHROWER,2,-338.3566,1985.2874,131.4921); // Flamethrower (lots of ammo)
		AddStaticPickup(PICKUP_TEC9,2,-258.8873,2042.0297,48.1047); // Tec-9
		AddStaticPickup(PICKUP_UZI,2,-149.3102,1989.7598,30.4239); // Micro Uzi

		AddStaticPickup(PICKUP_MINIGUN,2,-371.6570,2128.8850,133.1797); // Minigun (new set)
		AddStaticPickup(PICKUP_SHOVEL,2,-333.0277,2219.3123,42.4885); // Shovel
		AddStaticPickup(PICKUP_FLOWERS,2,-335.9626,2225.1255,42.4871); // Flowers

		AddStaticPickup(PICKUP_SAWEDOFF,2,-285.3163,1262.9303,24.8750); // Sawnoff
		AddStaticPickup(PICKUP_SAWEDOFF,2,-56.4050,1294.1333,12.1404); // Sawn-off
		AddStaticPickup(PICKUP_SAWEDOFF,2,541.1504,2361.0249,33.9793); // Sawnoff
		AddStaticPickup(PICKUP_TEC9,2,605.8316,2147.7361,41.3062); // Tec-9
		AddStaticPickup(PICKUP_DEAGLE,2,492.0047,1719.7748,11.2410); // Desert Eagle
		AddStaticPickup(PICKUP_DEAGLE,2,165.1940,1283.6234,20.7728); // Desert Eagle
		AddStaticPickup(PICKUP_SAWEDOFF,2,-343.2186,1546.4620,80.4334); // Micro Uzi
		AddStaticPickup(PICKUP_SHOTGSPA,2,-336.2724,1595.2528,95.5666); // Combat Shotgun
		AddStaticPickup(PICKUP_UZI,2,-346.5265,1584.6504,95.5346); // Uzi
		AddStaticPickup(PICKUP_AK47,2,-357.0659,1594.8313,95.5090); // AK-47

		AddStaticPickup(PICKUP_MINIGUN,2,-347.2831,1600.8020,165.7395); // Minigun
		...
		class_terrorist2 = AddPlayerClass2(183, WEAPON_COLT45,100, WEAPON_SHOTGUN,400, WEAPON_KNIFE,-1);
		class_terrorist3 = AddPlayerClass2(179, WEAPON_COLT45,100, WEAPON_SHOTGUN,400, WEAPON_KNIFE,-1);
		class_terrorist4 = AddPlayerClass2(191, WEAPON_COLT45,100, WEAPON_SHOTGUN,400, WEAPON_KNIFE,-1);
		class_terrorist5 = AddPlayerClass2(111, WEAPON_COLT45,100, WEAPON_SHOTGUN,400, WEAPON_KNIFE,-1);
		class_terrorist6 = AddPlayerClass2(73,  WEAPON_COLT45,100, WEAPON_SHOTGUN,400, WEAPON_KNIFE,-1);
		class_terrorist7 = AddPlayerClass2(100, WEAPON_COLT45,100, WEAPON_SHOTGUN,400, WEAPON_KNIFE,-1);
		class_terrorist_medic = AddPlayerClass2(274, WEAPON_COLT45,100,WEAPON_SHOTGUN,400,WEAPON_KNIFE,-1);
...
public OnPlayerConnect(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(DESERT MAP!) - (developed by Spark and Timberwolf)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(DESERT MAP!) - PM CANNOT DRIVE");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(DESERT MAP!) - LOOK FOR WEAPON PICKUPS, INCLUDING MINIGUNS");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(DESERT MAP!) - RUSTLERS IN THE AIRPORT");
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	if (numparams==0) {}
 	...
 	if (streq(cmd,"/reclass")) {
		...
		SendClientMessage(playerid, COLOUR_PERSONAL, "/heal /login <user> <pass>");
