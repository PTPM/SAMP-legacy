new mode_name[] = "Protect the Prime Minister 6.0";
...
AddObjective(Float:x, Float:y, Float:z, desc[], Float:size, time = 30)
{
	if (obj_counter>=NUM_OBJS) {
		printf("Too many objectives!  Ignoring (%f,%f,%f) %f %d.\n",x,y,z,size,time);
		return 0;
	}
	obj_x[obj_counter] = x;
	obj_y[obj_counter] = y;
...
{
	SendClientMessage(playerid,COLOUR_PERSONAL,"Usage: /mapvote ls|sf|desert|a51|lv|air|chilliad");
}
...
public PlayerMapVoteStatus(playerid)
{
	...
	new text[256];
	format(text, sizeof text,"Current scores: ls:%d, sf:%d, desert:%d, a51:%d, lv:%d, air:%d chilliad:%d", score[0], score[1], score[2], score[3], score[4],score[5],score[6]);
...
public MapVoteDisplayNextMap()
{
	...
	switch (map) {
	    ...
	    case 6 : SendClientMessageToAll(COLOUR_GLOBAL,"Next map: Mount Chilliad!");
	}
}
...
*/
		...
		AddStaticVehicle2(V_COPCARVG,-2373.6489,-2189.1133,33.2589, 306.1899,-1,-1);
		AddStaticVehicle2(V_COPCARVG,-2384.9880,-2190.4351,33.1205, 271.7669,-1,-1);
		AddStaticVehicle2(V_COPCARVG,-2399.0864,-2193.6462,33.1207, 291.7810,-1,-1);
		AddStaticVehicle2(V_COPCARVG,-2407.5723,-2203.2969,33.1206, 354.4473,-1,-1);

		AddStaticVehicle2(V_ENFORCER,-2397.4343,-2167.4753,33.1448, 269.6390,-1,-1); //  enforcer
        AddStaticVehicle2(V_SWATVAN,-2372.1985,-2168.1006,33.1763, 266.6502,-1,-1); //  swat-tank
        AddStaticVehicle2(V_ENFORCER,-2382.5354,-2167.6113,33.4210,270.1384,-1,-1); //  enforcer
		...
		AddStaticVehicle2(V_COPCARRU,-2394.6575,-2226.2749,33.1209, 354.7045,-1,-1); //
		...
		AddStaticVehicle2(V_QUAD,-2262.4348,-1688.9640,480.7627, 134.5143 ,-1,-1); //
		AddStaticVehicle2(V_QUAD,-2253.9365,-1696.9105,480.6137, 122.0135 ,-1,-1); //
		AddStaticVehicle2(V_QUAD,-2244.3474,-1707.9720,480.3198, 126.9971 ,-1,-1); //
		AddStaticVehicle2(V_CLOVER, -2346.8999,-1653.5042,483.5349, 276.7852,-1,-1); //
		AddStaticVehicle2(V_CLOVER,-2343.2556,-1660.0790,483.5347, 268.6202 ,-1,-1); //
		AddStaticVehicle2(V_BANDITO, -2353.5264,-1637.7627,483.5349, 257.1133,-1,-1); //
		AddStaticVehicle2(V_BANDITO,-2350.2319,-1646.6113,483.5347, 267.3527 ,-1,-1); //
		AddStaticVehicle2(V_MESA,-2340.7549,-1666.5654,483.4460, 257.7226 ,-1,-1); //
		AddStaticVehicle2(V_MESA, -2335.4614,-1591.5620,483.4898, 197.8641,-1,-1); //
		AddStaticVehicle2(V_MONSTER,-2289.0010,-1628.9275,483.5754, 120.6303 ,-1,-1); //
		AddStaticVehicle2(V_MONSTER,-2301.2537,-1615.9274,483.6929, 128.8499 ,-1,-1); //
		AddStaticVehicle2(V_NEVADA, -2332.4429,-1621.3170,483.5421, 223.1954,-1,-1,true); //
		...
		AddStaticVehicle2(V_CARGOBOB,-2395.4409,-2205.7458,33.1208, 294.8704 ,-1,-1); //


		AddStaticVehicle2(V_POLMAV,-1885.5658,-1533.3868,23.4462,173.7907,-1,-1); //
		AddStaticVehicle2(V_POLMAV,-1827.6298,-1572.0697,23.4160,121.4971,-1,-1); //
		AddStaticVehicle2(V_MONSTER,-1990.9425,-1454.9397,87.2293,141.1646,-1,-1); //
		...
		AddStaticVehicle2(V_RUSTLER,-2362.8147,-2258.7546,15.5000,115.9764,-1,-1,true); //
		AddStaticVehicle2(V_RUSTLER,-2287.4390,-2220.9763,27.1621,116.6371,-1,-1,true); //
		AddStaticVehicle2(V_RUSTLER,-2904.9067,-1389.0231,11.1150,21.6618,-1,-1,true); //
		AddStaticVehicle2(V_BEAGLE,-2242.6570,-2157.8938,39.7183,212.3638,-1,-1,true); //
		AddStaticVehicle2(V_BEAGLE,-2198.7346,-2131.2871,48.6255,204.3451,-1,-1,true); //
		AddStaticVehicle2(V_BEAGLE,-2904.6123,-1613.8972,12.4446,23.4101,-1,-1,true); //
		AddStaticVehicle2(V_DODO,-2099.7361,-2057.3215,63.5973,339.7149,-1,-1,true); //
		AddStaticVehicle2(V_DODO,-2915.7021,-1861.3938,31.7442,10.3758,-1,-1,true); //
		AddStaticVehicle2(V_DODO,-2864.7507,-1549.4207,139.5904,99.9337,-1,-1,true); //
		...
		AddStaticVehicle2(V_ZR350,-2771.7834,-1530.8959,139.2209,85.5879,-1,-1); //
		...
		AddStaticVehicle2(V_COMET,-2007.6163,-1506.0615,84.6317,190.6711,-1,-1); //
		AddStaticVehicle2(V_HUNTLEY,-2006.1495,-1519.3416,85.5952,183.1020,-1,-1); //
		...
		AddStaticVehicle2(V_COPCARVG,-1999.2424,-1578.2704,86.4753,182.4734,-1,-1); //
		AddStaticVehicle2(V_COPCARVG,-1999.4883,-1564.9413,86.2433,178.7807,-1,-1); //
		AddStaticVehicle2(V_COPCARVG,-1991.5387,-1571.0326,86.5412,185.6543,-1,-1); //
		...
		AddStaticVehicle2(V_QUAD,-2003.2914,-1606.0265,87.7402,267.2109,-1,-1); //
		...
		AddStaticVehicle2(V_DUMPER,-1875.0802,-1622.9042,22.1229,359.9089,-1,-1); //
		AddStaticVehicle2(V_DUMPER,-1823.0953,-1651.3756,22.1213,88.6411,-1,-1); //
		AddStaticVehicle2(V_DUMPER,-1882.4955,-1698.2845,22.1148,340.0495,-1,-1); //
		AddStaticVehicle2(V_ADMIRAL,-1866.2660,-1682.8884,22.1213,108.5859,-1,-1); //
		AddStaticVehicle2(V_ADMIRAL,-1857.5566,-1626.6881,22.3006,184.5594,-1,-1); //
		AddStaticVehicle2(V_TRASH,-1939.9333,-1788.5123,31.6928,299.5230,-1,-1); //


		AddStaticVehicle2(V_POLMAV,-2293.0376,-1658.7798,482.7570,265.2630,-1,-1); //
		AddStaticVehicle2(V_POLMAV,-2259.7168,-1739.6742,487.4732,204.9193,-1,-1); //
		AddStaticVehicle2(V_STUNT,-2260.3169,-1695.3792,480.0292,141.1965,-1,-1); //
		AddStaticVehicle2(V_SANCHEZ,-2351.4707,-1682.1578,484.7329,267.1730,-1,-1); //
		AddStaticVehicle2(V_ADMIRAL,-2287.8132,-1647.2915,482.8104,179.1228,-1,-1); //
		AddStaticVehicle2(V_MTBIKE,-2340.8691,-1584.6721,483.0329,166.1808,-1,-1); //
		AddStaticVehicle2(V_MTBIKE,-2332.7954,-1582.3513,483.0886,187.5527,-1,-1); //
		AddStaticVehicle2(V_MTBIKE,-2322.5271,-1589.0698,483.2328,138.6203,-1,-1); //
		AddStaticVehicle2(V_MTBIKE,-2312.4370,-1597.8247,483.3919,154.6588,-1,-1); //
		AddStaticVehicle2(V_MTBIKE,-2241.2612,-1747.5403,480.3405,331.6457,-1,-1); //
		...
		AddStaticVehicle2(V_BOBCAT,-2413.5105,-1824.7920,415.4131,37.8859,-1,-1); //
		AddStaticVehicle2(V_MTBIKE,-2433.0752,-1812.8022,411.7278,112.0382,-1,-1); //
		AddStaticVehicle2(V_COACH,-2444.0210,-1803.9321,410.3475,123.6048,-1,-1); //
		...
		AddStaticVehicle2(V_HUNTLEY,-2200.5259,-1580.3721,362.6252,354.5536,-1,-1); //
		AddStaticVehicle2(V_MTBIKE,-2197.8594,-1617.2303,364.9783,5.3690,-1,-1); //
		AddStaticVehicle2(V_TAXI,-2250.7349,-1446.7748,355.9400,41.0358,-1,-1); //
		AddStaticVehicle2(V_NRG500,-2352.0671,-1392.4644,358.3376,76.2791,-1,-1); //
		AddStaticVehicle2(V_NRG500,-2370.2078,-1388.3630,358.8773,70.8725,-1,-1); //
		AddStaticVehicle2(V_BUFFALO,-2551.8943,-1484.2795,359.9571,54.6059,-1,-1); //
		...
		AddStaticVehicle2(V_GLENDALE,-2362.5823,-1154.0608,173.7676,306.7439,-1,-1); //
		AddStaticVehicle2(V_POLMAV,-2816.5295,-1521.2769,146.7012,180.0988,-1,-1); //
		...
		AddStaticVehicle2(V_CARGOBOB,-2432.0959,-2187.9392,31.4855,107.2491,-1,-1); //
		...
		AddStaticVehicle2(V_TAXI,-2564.8586,-2147.1194,63.9549,280.0340,-1,-1); //
		...
		AddStaticVehicle2(V_STALLION,-2680.3987,-1729.8649,254.1751,62.6500,-1,-1); //
		...
		AddStaticVehicle2(V_MTBIKE,-2528.1829,-1808.8088,376.8376,6.1249,-1,-1); //
		...
		AddStaticVehicle2(V_HUNTLEY,-2701.0508,-2007.3579,44.7186,57.5140,-1,-1); //
		AddStaticVehicle2(V_TAXI,-2693.2258,-2069.7917,36.0705,196.7303,-1,-1); //
		...
		AddStaticVehicle2(V_COACH,-2880.9102,-984.2347,9.6843,258.6531,-1,-1); //
		...
		AddStaticVehicle2(V_CLOVER,-2194.1802,-1167.0858,15.8614,205.4655,-1,-1); //
		...
		AddStaticVehicle2(V_PREDATOR,-1562.9570,-1698.8572,-0.5900,305.0941,-1,-1); //
		AddStaticVehicle2(V_MONSTER,-1651.4672,-2235.2122,29.8256,170.8282,-1,-1); //
		AddStaticVehicle2(V_COPCARVG,-1642.0264,-2251.7205,31.2759,91.8318,-1,-1); //
		...
		AddStaticVehicle2(V_PREDATOR,-2278.2468,-1021.8701,-0.2242,56.1533,-1,-1); //
		...
		AddStaticVehicle2(V_PREDATOR,-1540.0782,-2301.7292,-0.2051,14.4143,-1,-1); //
		AddStaticVehicle2(V_PREDATOR,-1528.3134,-2320.6606,-0.2566,0.5508,-1,-1); //
		...
		AddStaticVehicle2(V_REEFER,-1631.0994,-1635.5319,-0.1933,52.0787,-1,-1); //
		AddStaticVehicle2(V_REEFER,-1750.8533,-1538.3230,-0.1854,55.3674,-1,-1); //
		AddStaticVehicle2(V_REEFER,-1483.0880,-1675.0219,-0.1841,247.2354,-1,-1); //

		AddStaticVehicle2(V_COACH,-1592.6948,-1606.1011,36.1328,202.7539,-1,-1); //
		AddStaticVehicle2(V_COACH,-1660.7017,-1635.5104,36.1328,23.7544,-1,-1); //
		AddStaticVehicle2(V_COACH,-1728.6079,-1662.9894,36.1328,201.8073,-1,-1); //
		AddStaticVehicle2(V_COACH,-1185.0217,-2639.1133,11.5059,1.6670,-1,-1); //
		...
		AddStaticVehicle2(V_SANCHEZ,-2831.3967,-1523.8119,138.6470,184.6001,-1,-1); //
		AddStaticVehicle2(V_COPCARVG,-1640.2782,-2223.4880,30.6599,99.1813,-1,-1); //
		AddStaticVehicle2(V_COPCARVG,-1646.9988,-2241.8115,30.2725,184.2397,-1,-1); //
		AddStaticVehicle2(V_COPCARVG,-1646.5533,-2209.4268,33.3577,96.6930,-1,-1); //
		AddStaticVehicle2(V_COPCARVG,-1635.1289,-2257.8247,31.8573,90.1367,-1,-1); //
		...
		AddStaticVehicle2(V_SULTAN,-2099.9846,-2477.3682,30.3714,231.1153,-1,-1); //
		...
		AddStaticVehicle2(V_QUAD,-1606.4072,-2713.3533,48.2824,52.6981,-1,-1); //
		...
		AddStaticVehicle2(V_PATRIOT,-13.3326,-2509.6992,36.3999,121.1489,-1,-1); //
		...
		AddStaticVehicle2(V_SULTAN,-86.9996,-1196.3778,1.9998,345.4369,-1,-1); //
		...
		AddTeamLineSpawn(TEAM_PSYCHO, -2347.5027,-1576.2601,485.8103, -2327.9197,-1582.7904,483.6537);

		AddTeamLineSpawn(TEAM_TERRORIST, -2818.3855,-1528.6583,140.8438, -2818.3799,-1517.6608,140.8438);
		AddTeamLineSpawn(TEAM_TERRORIST, -2812.3926,-1520.6331,140.8438, -2806.2354,-1519.7957,140.7835);
		...
		AddTeamLineSpawn(TEAM_COP, -2418.2229,-2173.0720,33.3544, -2375.1992,-2163.2297,34.8049);
...
public OnPlayerConnect(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(EVERY MAP NOW HAS ALL SINGLE PLAYER GAME PICKUPS!)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(New Chilliad map from RambopaPpa!)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(More cars at LS terrorist spawn.)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(PTPM forum: http://www.puppyluvscreations.com/ptpm/)");
...
EveryoneViewsBody(killerid,bodyplayerid)
{
	...
	if (d>5) {
		...
		/* just use the killer's position
		vx = vx / d * 5;
		vy = vy / d * 5;
		vz = vz / d * 5 + 1;
		*/
...
public RoundTick()
{
	...
	if (obj_counter==0 && round_timer_counter%150==10 && round_timer_counter==0 && round_timer_counter<round_time) {
	    for (new i=0 ; i<MAX_PLAYERS ; i++) if (IsPlayerConnected(i) && player_class[i]!=INVALID_CLASS) {
	        new team=class_team[player_class[i]];
	        if (team==TEAM_PRIMEMINISTER || team==TEAM_BODYGUARD || team==TEAM_COP) {
				new msg[256];
				format(msg,sizeof msg,"~b~%d minutes to secure objectives",(round_time-round_timer_counter)/60);
				GameTextForPlayer(i,msg,5000,GAME_TEXT_STYLE_SMALL);
			} else {
				new msg[256];
				format(msg,sizeof msg,"~b~%d minutes left",(round_time-round_timer_counter)/60);
				GameTextForPlayer(i,msg,5000,GAME_TEXT_STYLE_SMALL);
			}
		}
	}
			...
			for (new j=0 ; j<MAX_PLAYERS ; j++) if (IsPlayerConnected(j)) {
			    if (player_class[j]==class_bodyguard_medic ||
				    ...
				    if (DistanceFromPlayerToPlayer(i,j)<10) {
						new Float:health;
						GetPlayerHealth(i,health);
						if (health<100) SetPlayerHealth(j,health+1);
					}
				}
			}
		}
...
public OnPlayerCommandText(playerid, cmdtext[])
{
 	...
 	if (streq(cmd,"/reclass")) {
	...
	} else if (strcmp(cmdtext, "/unquery", true)==0) {
       player_query_target[playerid]=INVALID_PLAYER_ID;
       ...
       return 1;
		...
		if(player_op[playerid]) {
			...
			SendClientMessage(playerid, COLOUR_PERSONAL, "/force <name> <cmd>  /tell <text> /say");
	...
	if (player_op[playerid]) {
		if (streq(cmd,"/kick")) {
			...
			player_watching[playerid] = INVALID_PLAYER_ID;
			DisruptTrack(playerid);
			SetPlayerColor(playerid,TeamColour(class_team[player_class[playerid]]));  // for radar visibility
			SetPlayerPosAtSelf(playerid);
			return 1;
			...
			new text[256];
			format (text,sizeof text,"Warped by (%f,%f,%f)",x+dx,y+dy,z+dz);
			SendClientMessage(playerid, COLOUR_PERSONAL, text);
			return 1;
