new mode_name[] = "Protect the Prime Minister 9.6";
...
Motd(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: SF modified boundaries, other maps next)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(please report boundary issues (stuck, interiors, etc) to forum)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: more vehicles on SF)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: psychos have proper spawns on SF)");
