new mode_name[] = "Protect the Prime Minister 5.1";
...
{
	SendClientMessage(playerid,COLOUR_PERSONAL,"Usage: /mapvote ls|sf|desert|a51|lv");
}
...
public PlayerMapVoteStatus(playerid)
{
	...
	new text[256];
	format(text, sizeof text,"Current scores: ls:%d, sf:%d, desert:%d, a51:%d, lv:%d, air:%d", score[0], score[1], score[2], score[3], score[4],score[5]);
...
public OnGameModeInit()
{
	...
	if (map==0) {
		...
		AddStaticVehicle2(V_SPARROW,2737.4866,-1760.1506,44.1182,224.5974,75,2,true); // sparrow1
		AddStaticVehicle2(V_SPARROW,1568.8612,-1238.7914,277.8883,49.2131,75,2,true); // sparrow2
...
//		AddStaticVehicle2(V_SKIMMER, -1333.1960,903.7660,1.5568,0.5095, -1,-1);
		...
		AddStaticVehicle2(V_MAVERICK,1572.2100,-1241.3137,278.5058,150.5667,6,65); // pm's maverick
		...
		AddStaticVehicle2(V_SPARROW,-1271.2039,499.1599,18.4078,263.0863,-1,-1,true); // SPARROW
		AddStaticVehicle2(V_SPARROW,-1424.2411,500.2336,18.4057,267.5629,-1,-1,true); // SPARROW
		...
		class_psycho1 = AddPlayerClass2(230,-1,-1,-1,-1,-1,-1);
		class_psycho2 = AddPlayerClass2(212,-1,-1,-1,-1,-1,-1);
		class_psycho3 = AddPlayerClass2(200,-1,-1,-1,-1,-1,-1);
		class_psycho4 = AddPlayerClass2(137,-1,-1,-1,-1,-1,-1);

		class_terrorist1 = AddPlayerClass2(181, WEAPON_COLT45,12, -1,-1, -1,-1);
		class_terrorist2 = AddPlayerClass2(183, WEAPON_COLT45,12, -1,-1, -1,-1);
		class_terrorist3 = AddPlayerClass2(179, WEAPON_COLT45,12, -1,-1, -1,-1);
		class_terrorist4 = AddPlayerClass2(191, WEAPON_COLT45,12, -1,-1, -1,-1);
		class_terrorist5 = AddPlayerClass2(111, WEAPON_COLT45,12, -1,-1, -1,-1);
		class_terrorist6 = AddPlayerClass2(73,  WEAPON_COLT45,12, -1,-1, -1,-1);
		class_terrorist7 = AddPlayerClass2(100, WEAPON_COLT45,12, -1,-1, -1,-1);
		class_terrorist_medic = INVALID_CLASS;

		class_primeminister = AddPlayerClass2(147,WEAPON_CANE,-1,WEAPON_SPRAYCAN,100, -1,-1);

		class_bodyguard1 = AddPlayerClass2(163,WEAPON_COLT45,12,-1,-1, -1,-1);
		class_bodyguard2 = AddPlayerClass2(164,WEAPON_COLT45,12,-1,-1, -1,-1);
		class_bodyguard3 = AddPlayerClass2(165,WEAPON_COLT45,12,-1,-1, -1,-1);
		class_bodyguard4 = AddPlayerClass2(166,WEAPON_COLT45,12,-1,-1, -1,-1);
		class_bodyguard5 = AddPlayerClass2(141,WEAPON_COLT45,12,-1,-1, -1,-1);
		class_bodyguard_medic = INVALID_CLASS;


		class_cop1  = AddPlayerClass2(280, WEAPON_COLT45,12,-1,-1,-1,-1);
		class_cop2  = AddPlayerClass2(281, WEAPON_COLT45,12,-1,-1,-1,-1);
		class_cop3  = AddPlayerClass2(282, WEAPON_COLT45,12,-1,-1,-1,-1);
		class_cop4  = AddPlayerClass2(283, WEAPON_COLT45,12,-1,-1,-1,-1);
		class_cop5  = AddPlayerClass2(284, WEAPON_COLT45,12,-1,-1,-1,-1);
		class_cop6  = AddPlayerClass2(285, WEAPON_COLT45,12,-1,-1,-1,-1);
		class_cop7  = AddPlayerClass2(286, WEAPON_COLT45,12,-1,-1,-1,-1);
		class_cop8  = AddPlayerClass2(288, WEAPON_COLT45,12,-1,-1,-1,-1);
		class_cop9  = AddPlayerClass2(246, WEAPON_COLT45,12,-1,-1,-1,-1);
...
public OnPlayerConnect(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(New \"AIR BATTLE\" MAP!)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(PM MUST NOT EXIT VEHICLE!)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(PM CANNOT SWIM!)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(weapons now on air map)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(cop car fixed on lv)");
...
public RoundTick()
{
	...
	if (pm_abandoned_health_penalty && pm!=INVALID_PLAYER_ID && !pm_fresh && !IsPlayerInAnyVehicle(pm)) { // 1% health every second
		new Float:health;
		GetPlayerHealth(pm,health);
		SetPlayerHealth(pm,health - 1);
	}
