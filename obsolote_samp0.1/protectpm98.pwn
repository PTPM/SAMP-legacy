new mode_name[] = "Protect the Prime Minister 9.8";
...
Motd(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(FIXED: a51)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(FIXED: spawn angles)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: BOATS ON LS)");
