new mode_name[] = "Protect the Prime Minister 9.3";
...
Motd(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(factory: fixed /camoff)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(sf: removed minigun)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(can't reclass if frozen)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(factory: removed grenades, put player markers back on)");
