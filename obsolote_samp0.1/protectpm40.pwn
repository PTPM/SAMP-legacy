new mode_name[] = "Protect the Prime Minister 4.0";
...
//   	printf("obj_size[%d] = %f",obj_current,obj_size[obj_current]);
	...
	new text[256];
	format (text, sizeof text, "~b~PM Objective: ~w~%s~n~~b~Objectives left: %d~n~(/duty for instructions)", obj_desc[obj_current],obj_required-obj_completed);
