new mode_name[] = "Protect the Prime Minister 6.1";
...
*/
		...
		AddStaticVehicle2(V_LEVIATHN,-2390.6204,-2204.1663,33.3788,117.7673 ,-1,-1); // changed
		...
		AddStaticVehicle2(V_BEAGLE,-2236.8481,-2161.9714,41.7670,211.6201,-1,-1,true); //
		...
		AddStaticVehicle2(V_DUMPER,-1934.0021,-1694.2391,23.2745,272.4344,-1,-1); // changed
		AddStaticVehicle2(V_DUMPER,-1823.0953,-1651.3756,22.1213,88.6411,-1,-1); //
		AddStaticVehicle2(V_DUMPER,-1930.1538,-1703.4938,23.2751,271.0763,-1,-1); // changed
		AddStaticVehicle2(V_ADMIRAL,-1893.7970,-1693.0510,21.6189,271.5607,-1,-1); // changed
		AddStaticVehicle2(V_ADMIRAL,-1857.5566,-1623.6881,22.3006,184.5594,-1,-1); // changed
		AddStaticVehicle2(V_TRASH,-1890.7816,-1750.5702,22.2951,303.5776,-1,-1); // changed


		AddStaticVehicle2(V_MAVERICK,-2293.0376,-1658.7798,482.7570,265.2630,-1,-1); //
		AddStaticVehicle2(V_MAVERICK,-2259.7168,-1739.6742,487.4732,204.9193,-1,-1); //
		...
		//AddStaticVehicle2(V_LEVIATHN,-2432.0959,-2187.9392,31.4855,107.2491,-1,-1); // rolls down the hill
...
public OnPlayerConnect(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(Moved some of the annoying car spawns on Chilliad.)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(New /me command created by PuppyLuv!)");
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	if (numparams==0) {}
 	...
 	if (streq(cmd,"/reclass")) {
		...
		SendClientMessageToAll(COLOUR_QUERY, text);
		return 1;
