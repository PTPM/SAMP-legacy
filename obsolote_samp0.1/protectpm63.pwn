new mode_name[] = "Protect the Prime Minister 6.3";
...
public OnPlayerConnect(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(Misc. fixes from R3mp and Sniper89)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(Countryside map COMING SOON!)");
