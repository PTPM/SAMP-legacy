new mode_name[] = "Protect the Prime Minister 4.3";
...
public OnPlayerConnect(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(Timelimit for PM on LV)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(More admin commands from R3mp)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(A few bugfixes)");
