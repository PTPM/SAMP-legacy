new mode_name[] = "Protect the Prime Minister 5.2";
...
public OnPlayerConnect(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(air: pm loses health out of vehicle!)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(air: pm dies if he goes underwater!)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(air: more weapons)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(air: pm now has choice of planes)");
