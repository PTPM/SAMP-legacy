 new mode_name[] = "Protect the Prime Minister10.1";
...
// AddSecurityCamera();
		...
		AddStaticVehicle2(V_BUS,-1288.0488,2712.9082,50.0625,186.0612,-1,-1);
...
Motd(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: Bayside map by Puppyluv!)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: Las Venturas: modified boundaries, more vehicles and weapons)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(please report boundary issues (stuck, interiors, etc) to forum)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: Medic and Ambulance healing integration)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: Various fixes and changes)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: Fixed passenger-occupied car-entry bug)");
