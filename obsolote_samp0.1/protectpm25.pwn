...
new mode_name[] = "Protect the Prime Minister 2.5";
...
public OnPlayerConnect(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(Fixed more balancing bugs)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW MAP!)");
