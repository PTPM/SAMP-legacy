new mode_name[] = "Protect the Prime Minister 9.7";
...
//		AddBannedCuboid(230,225,1874,1869,14,0,"",248.8800,1849.9883,8.7734,0);
		...
		AddGameBoundaryCorner(763.8895,525.6904);
		AddGameBoundaryCorner(763.8895,2994.7202);
...
Motd(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: non-rectangular boundaries)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: COUNTRYSIDE modified boundaries, more maps soon)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(please report boundary issues (stuck, interiors, etc) to forum)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: NEW TERRORIST SPAWN ON LS)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: more vehicles on LS)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: psychos have proper spawns on LS)");
