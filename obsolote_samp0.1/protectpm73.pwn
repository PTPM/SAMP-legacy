new mode_name[] = "Protect the Prime Minister 7.3";
...
public OnPlayerConnect(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: some changes to chiliad)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(NEW: COUNTRYSIDE MAP BY R3MP!)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(PM: Look out for tasks around the map)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(coming soon: new desert boundaries)");
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(fixed: stealth pm is now temporary, lv objectives work again)");
