new mode_name[] = "Protect the Prime Minister 7.5";
...
//		AddStaticPickup(PICKUP_PARACHUTE,2,1529.0437,-1364.1820,327.8988); // parachute
		...
		AddStaticVehicle2(448,178.6630,1170.8038,14.3573,142.0272,-1,-1); // pizzaboy
...
//		AddWeaponPickup(PICKUP_FLAMETHROWER,WEAPON_FLAMETHROWER,15,-49.07,3.09,3.10,WP_NO_RESPAWN,WP_SYNCED);
	...
	//	game_boundary_max_x = 2109.3298; // Extension
		...
		AddTask(2766.74,80.49,19.71,13.0,TASK_VEHICLES,60);
...
public OnPlayerConnect(playerid)
{
	...
	SendClientMessage(playerid,COLOUR_IMPORTANT,"(new: various fixes and improvements)");
